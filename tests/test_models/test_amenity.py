...
class TestAmenity_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        amty = Amenity()
        amty.id = "123456"
        amty.created_at = amty.updated_at = dtm
        amstr = amty.__str__()
        self.assertIn("[Amenity] (123456)", amtystr)
        self.assertIn("'id': '123456'", amtystr)
        self.assertIn("'created_at': " + dtm_repr, amtystr)
        self.assertIn("'updated_at': " + dtm_repr, amtystr)
    ...
    def test_instantiation_with_kwargs(self):
        """testing instantiation with kwargs test method"""
        dtm = datetime.today()
        dtm_iso = dtm.isoformat()
        amty = Amenity(id="345", created_at=dtm_iso, updated_at=dtm_iso)
        self.assertEqual(amty.id, "345")
        self.assertEqual(amty.created_at, dtm)
        self.assertEqual(amty.updated_at, dtm)
