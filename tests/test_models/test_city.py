...
class TestCity_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        cty = City()
        cty.id = "123456"
        cty.created_at = cty.updated_at = dtm
        ctystr = cty.__str__()
        self.assertIn("[City] (123456)", ctystr)
        self.assertIn("'id': '123456'", ctystr)
        self.assertIn("'created_at': " + dtm_repr, ctystr)
        self.assertIn("'updated_at': " + dtm_repr, ctystr)
    ...
    def test_instantiation_with_kwargs(self):
        dtm = datetime.today()
        dtm_iso = dt.isoformat()
        cty = City(id="345", created_at=dtm_iso, updated_at=dtm_iso)
        self.assertEqual(cty.id, "345")
        self.assertEqual(cty.created_at, dtm)
        self.assertEqual(cty.updated_at, dtm)
...
class TestCity_save(unittest.TestCase):
    ...
    def test_save_updates_file(self):
        ...
        with open("file.json", "r") as json_file:
            self.assertIn(ctyid, json_file.read())
